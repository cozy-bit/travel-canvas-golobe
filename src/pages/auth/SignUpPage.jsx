...
import { UserPlus, BookOpen, ExternalLink, Code2 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-3xl border-2 border-dashed border-[#8DD3BB] p-8 sm:p-12 text-center shadow-sm">
          ...
          <p className="text-base text-gray-600 max-w-xl mx-auto mb-8 leading-relaxed">
            ...
            Файл компонента: <code className="bg-gray-100 px-2 py-1 rounded text-sm text-black font-semibold">src/pages/auth/SignUpPage.jsx</code>.
          </p>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 text-left max-w-lg mx-auto mb-8 border border-gray-100">
            ...
            <ul className="text-xs sm:text-sm text-gray-600 space-y-2 list-disc pl-5">
              <li>Поля: Имя, Фамилия, Email, Номер телефона, Пароль, Подтверждение пароля</li>
              <li>Чекбокс согласия с правилами (Terms & Privacy)</li>
              <li>Кнопка регистрации (Create account) и ссылка на Login</li>
              <li>Иллюстрация справа (ассет готов: <code>src/assets/images/auth/signup-side.png</code>)</li>
            </ul>
          </div>
